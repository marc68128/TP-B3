...
namespace TP7SchoolManagement.Controllers
{
    ...
    {
        private SupinfoContext db = new SupinfoContext();
        ...
        public ActionResult Create([Bind(Include = "Id,Name,JoinDate,HasPaid,Class,SchoolId")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,JoinDate,HasPaid,Class,SchoolId")] Student student)
        {
            if (ModelState.IsValid)
            {
